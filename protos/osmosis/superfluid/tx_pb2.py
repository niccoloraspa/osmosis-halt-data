...
_MSGUNPOOLWHITELISTEDPOOL = DESCRIPTOR.message_types_by_name['MsgUnPoolWhitelistedPool']
_MSGUNPOOLWHITELISTEDPOOLRESPONSE = DESCRIPTOR.message_types_by_name['MsgUnPoolWhitelistedPoolResponse']
MsgSuperfluidDelegate = _reflection.GeneratedProtocolMessageType('MsgSuperfluidDelegate', (_message.Message,), {
...
MsgSuperfluidDelegateResponse = _reflection.GeneratedProtocolMessageType('MsgSuperfluidDelegateResponse', (_message.Message,), {
...
MsgSuperfluidUndelegate = _reflection.GeneratedProtocolMessageType('MsgSuperfluidUndelegate', (_message.Message,), {
...
MsgSuperfluidUndelegateResponse = _reflection.GeneratedProtocolMessageType('MsgSuperfluidUndelegateResponse', (_message.Message,), {
...
MsgSuperfluidUnbondLock = _reflection.GeneratedProtocolMessageType('MsgSuperfluidUnbondLock', (_message.Message,), {
...
MsgSuperfluidUnbondLockResponse = _reflection.GeneratedProtocolMessageType('MsgSuperfluidUnbondLockResponse', (_message.Message,), {
...
MsgLockAndSuperfluidDelegate = _reflection.GeneratedProtocolMessageType('MsgLockAndSuperfluidDelegate', (_message.Message,), {
...
MsgLockAndSuperfluidDelegateResponse = _reflection.GeneratedProtocolMessageType('MsgLockAndSuperfluidDelegateResponse', (_message.Message,), {
...
MsgUnPoolWhitelistedPool = _reflection.GeneratedProtocolMessageType('MsgUnPoolWhitelistedPool', (_message.Message,), {
...
MsgUnPoolWhitelistedPoolResponse = _reflection.GeneratedProtocolMessageType('MsgUnPoolWhitelistedPoolResponse', (_message.Message,), {
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _MSGUNPOOLWHITELISTEDPOOLRESPONSE._serialized_end=917
  _MSG._serialized_start=920
  _MSG._serialized_end=1548
